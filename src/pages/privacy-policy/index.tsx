  ...
  return (
    <Wrapper>
      <FlexContainer variant="column-start" className="max-w-3xl" gap="xl">
        ...
        <Heading>
          Neet Bucket is committed to ensuring that your privacy is protected.
        ...
        <Heading>
          Neet Bucket may change this policy from time to time by updating this
          page. You should check this page from time to time to ensure that you
          are happy with any changes.
        </Heading>
        <Heading>We may collect the following information:</Heading>
        <Heading>Name and job title</Heading>
        <Heading>Contact information including email address</Heading>
        <Heading>
        ...
        <Heading>What we do with the information we gather</Heading>
        <Heading>
          We require this information to understand your needs and provide you
          with a better service, and in particular for the following reasons:
        </Heading>
        <Heading>Internal record keeping.</Heading>
        <Heading>
        ...
        <Heading>
          ...
          writing to or emailing us at ayaan@neetbucket.com
        </Heading>
        <Heading>
