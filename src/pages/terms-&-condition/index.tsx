  ...
  return (
    <Wrapper>
      <FlexContainer variant="column-start" gap="xl" className="max-w-3xl">
        <Heading variant="h3">Terms and Conditions</Heading>
        <Heading>
        ...
        <Heading>
          ...
          Neet Bucket&apos;s relationship with you in relation to this website.
        </Heading>
        <Heading>
          The term &apos;Neet Bucket&apos; or &apos;us&apos; or &apos;we&apos;
          refers to the owner of the website whose registered/operational office
          is 34 Taltala Lane Kolkata 700016 Kolkata WEST BENGAL 700016. The term
